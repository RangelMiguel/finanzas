...
export async function POST(req: Request) {
  try {
    ...
    await prisma.$transaction([
      ...
      prisma.propertyItem.deleteMany({ where: { householdId: m.householdId } }),
      prisma.pricePurchase.deleteMany({ where: { householdId: m.householdId } }),
      prisma.priceQuote.deleteMany({ where: { householdId: m.householdId } }),
