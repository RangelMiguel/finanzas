export const es = {
  ...
  cards: {
    ...
    adjustProcessing: "Ajustar por procesamiento",
    adjustProcessingTitle: "Ajustar por procesamiento",
    adjustProcessingHint:
      "A veces un cargo se hace antes del corte pero el banco lo procesa después y cae en el siguiente ciclo. Escribe el saldo al corte del estado de cuenta (cargos facturados, no el saldo después de pagar).",
    adjustStatementBalance: "Saldo al corte",
    adjustAppCharged: "Cargos en la app",
    adjustDifference: "Diferencia",
    adjustAppHigher:
      "La app tiene {amount} más que el banco. Marca los cargos que se procesaron tarde para pasarlos al siguiente ciclo.",
    adjustAppLower:
      "El banco facturó {amount} más. Marca cargos del siguiente ciclo que se hayan procesado antes del corte, o deshaz un ajuste.",
    adjustMatch: "El saldo al corte coincide con la app.",
    adjustSuggested: "Sugerencia",
    adjustSuggestedExact: "Coincide exacto",
    adjustSuggestedClose: "Casi: faltan {amount}",
    adjustUseSuggestion: "Usar esta sugerencia",
    adjustSelected: "Seleccionados {selected} de {target}",
    adjustSelectedMatch: "La selección coincide",
    adjustMoveNext: "Mover al siguiente ciclo",
    adjustPullThis: "Traer a este ciclo",
    adjustRestore: "Regresar a este ciclo",
    adjustAlreadyMoved: "Ya movidos al siguiente ciclo",
    adjustFromNext: "Cargos del siguiente ciclo",
    adjustSuccess: "Ciclo ajustado",
    adjustNothing: "Selecciona al menos un cargo",
    adjustShifted: "Ajustado por procesamiento",
    adjustUndoShift: "Deshacer ajuste",
    adjustEnterBalance: "Escribe el saldo al corte para calcular la diferencia y sugerir cargos.",
    adjustNoCandidates: "No hay cargos para ajustar en este ciclo.",
    adjustConfirmUndo: "¿Regresar este cargo a su ciclo original según la fecha de compra?",
  },
  ...
  debts: {
    title: "Deudas",
    subtitle: "Pagos, intereses y cómo cambia el costo si pagas más o menos",
    new: "Nueva deuda",
    principal: "Principal",
    ...
    nextPayment: "Próximo pago",
    nextInterest: "Intereses de este mes",
    nextCapital: "A capital",
    paidInterest: "Intereses ya pagados",
    ifYouKeepPaying: "Si sigues pagando {payment} al mes",
    payoffIn: "Terminas en {duration}",
    totalInterestLeft: "Intereses por pagar {amount}",
    wontPayOff:
      "Este pago no cubre los intereses. El saldo no baja (o sube).",
    minToReduce: "Mínimo para reducir el saldo: {amount}",
    simulate: "Probar otro plan de pago",
    tryPayment: "Pago a simular",
    savePayment: "Usar este pago mensual",
    savePlan: "Usar este plan",
    paymentSaved: "Pago actualizado",
    planSaved: "Plan de pagos actualizado",
    interestSaved: "Ahorras {amount} de intereses",
    interestExtra: "Pagarías {amount} más de intereses",
    fasterBy: "Terminas {duration} antes",
    slowerBy: "Tardas {duration} más",
    samePlan: "Mismo tiempo e intereses",
    durationMonths: "{n} meses",
    durationYears: "{y} años",
    durationYearsMonths: "{y} años y {m} meses",
    schedule: "Cómo se aplica el interés",
    scheduleMonth: "Mes",
    zeroRate:
      "La tasa está en 0%. Pon el % anual para ver intereses y el efecto del pago.",
    ...
    planStep: "Pago {n}",
    planSum: "Suma del plan (efectivo): {amount}",
    planVsRemaining: "Capital pendiente: {remaining}",
    planShort: "El efectivo del plan es menor que el capital (faltan {amount} solo de capital).",
    planLong: "El plan tiene {amount} más que el capital; parte puede ir a intereses.",
    planMatch: "La suma del plan es igual al capital (aún puede faltar por intereses).",
    planPaysOff: "Este plan liquida la deuda. Intereses totales en el plan: {interest}.",
    planLeavesBalance:
      "Después del plan aún deberías {amount}. Los intereses consumen parte de cada pago (no solo el capital).",
    planInterestShort:
      "La suma del plan cubre el capital en papel, pero con intereses quedaría un saldo de {amount}. Aumenta algún pago o añade cuotas.",
  ...
  settings: {
    ...
    meatLink: {
      title: "Conexión con Meat",
      subtitle:
        "Cuando marques la lista de compras como comprada en Meat, ese gasto llega aquí como un movimiento.",
      enable: "Aceptar gastos desde Meat",
      generate: "Generar llave",
      rotate: "Regenerar llave",
      revoke: "Revocar llave",
      tokenOnce: "Copia esta llave ahora. No se volverá a mostrar completa.",
      tokenCopied: "Llave copiada",
      copyKey: "Copiar llave",
      hasToken: "Llave activa ({prefix}…)",
      noToken: "Aún no hay llave. Genera una para conectar Meat.",
      account: "Cuenta que paga",
      card: "O tarjeta (si no usas cuenta)",
      category: "Categoría",
  ...
  ai: {
    ...
    provider: "Proveedor",
    providerXai: "SpaceXAI (Grok / xAI)",
    providerOpenai: "OpenAI",
    providerGemini: "Gemini",
    providerCustom: "Modelo local / URL propia (Ollama, LM Studio…)",
    baseUrl: "URL base",
    baseUrlHint: "Para local: http://127.0.0.1:11434/v1 (Ollama) o http://127.0.0.1:1234/v1 (LM Studio).",
    model: "Modelo",
    apiKey: "Llave de API",
    apiKeyHint: "Pega tu llave. En modelos locales a menudo puedes dejarla vacía.",
    clearKey: "Quitar llave",
    ...
    consentBody:
      "Al preguntar, Finance arma un resumen de cuentas, movimientos, presupuestos y deudas visibles para ti y lo envía al proveedor que configuraste (xAI, OpenAI, Google u un modelo en tu red). No usamos una llave de Finance: va por tu cuenta y puede quedar sujeto a la política de ese proveedor.",
    consentCheck: "Entiendo y acepto enviar un resumen de mis datos registrados a ese proveedor.",
  ...
  marketplace: {
    ...
    modules: {
      ...
      prices: {
        ...
        description:
          "Compara el mismo producto en varias tiendas y vincula compras a movimientos para ver cuánto ahorraste o dejaste de ahorrar.",
      },
      investments: {
  ...
  properties: {
    ...
    paymentDay: "Día de pago",
    financeLink: "Crédito de este bien",
    financeNone: "Sin hipoteca ni préstamo",
    financeExisting: "Vincular un pasivo existente",
    financeCreate: "Crear hipoteca / préstamo",
    financeHint:
      "Casa − hipoteca = patrimonio. El pago mensual se registra en Deudas, no aquí.",
    equity: "Patrimonio",
    equityOf: "Patrimonio {amount}",
    linkedLiability: "Pasivo: {name}",
    ...
    chartTitle: "Valor en el tiempo",
    chartNeedDates: "Pon una fecha de adquisición para ver la gráfica.",
    chartHousehold: "Patrimonio en el tiempo",
    chartFuture: "Proyectar 3 años",
    chartLegendValue: "Valor",
    chartLegendEstimate: "Estimado",
    chartLegendEquity: "Patrimonio",
    ownership: "Dueños",
    ownershipHint:
      "Parte de cada miembro. Lo que no se asigne queda como del hogar.",
    ownershipHousehold: "Hogar (sin asignar)",
    ownershipTotal: "Asignado {pct}%",
    ownershipOver: "Suma {pct}% — no puede pasar de 100%.",
    splitEqual: "Repartir igual",
    shareOf: "{name} · {pct}%",
    byOwner: "Por dueño",
    categories: {
      home: "Casa / inmueble",
  ...
  prices: {
    title: "Precios por tienda",
    subtitle: "Compara y vincula compras a movimientos para ver el ahorro real",
    stores: "Tiendas",
    items: "Productos",
    addStore: "Agregar tienda",
    seedStores: "Tiendas comunes MX",
    ...
    unitL: "Litro",
    unitPack: "Paquete",
    addQuote: "Registrar precio",
    unitPrice: "Precio unitario",
    observedOn: "Fecha del precio",
    latest: "Últimos precios",
    cheapest: "Más barato: {store} {amount}",
    noQuotes: "Aún no hay precios. Registra uno o vincula una compra.",
    noItems: "Agrega leche, huevo, gasolina… lo que quieras comparar.",
    noStores: "Agrega las tiendas donde compras.",
    linkPurchase: "Vincular movimiento",
    pickTxn: "Movimiento",
    quantity: "Cantidad",
    paidTotal: "Total pagado (vacío = el del movimiento)",
    purchases: "Compras vinculadas",
    saved: "Ahorraste {amount} vs la tienda más barata conocida",
    couldSave: "Pudiste ahorrar {amount} comprando en {store}",
    noCompare: "Sin otras tiendas para comparar",
    paidUnit: "Pagaste {amount} / {unit}",
    totalsSaved: "Ahorrado eligiendo bien",
    totalsCould: "Dejado de ahorrar",
    totalsSpent: "Gastado en compras vinculadas",
    linked: "Compra vinculada",
    created: "Creado",
    quoteAdded: "Precio guardado",
    confirmDelete: "¿Eliminar?",
    emptyTxns: "No hay gastos recientes para vincular.",
  },

  investments: {
    title: "Inversiones avanzadas",
    subtitle:
      "Mejor opción según tu riesgo, plazo e ISR. Es una guía, no asesoría fiscal.",
    risk: "Nivel de riesgo",
    riskLow: "Bajo (conservar)",
    riskMedium: "Medio",
    riskHigh: "Alto (crecer)",
    horizon: "Horizonte (años)",
    amount: "Monto a invertir",
    tax: "Tasa marginal ISR %",
    taxHint: "Tu tasa efectiva o el tramo (0–35). Cambia el ranking de CETES vs acciones.",
    best: "Mejor para ti",
    afterTax: "Rendimiento neto ≈ {pct}%",
    preTax: "Bruto {pct}%",
    taxDrag: "Impuesto estimado {pct} pts",
    yearGain: "En un año ≈ {amount} (después de ISR)",
    yearTax: "ISR estimado {amount}",
    liquidity: "Liquidez ~{n} días",
    why: "Por qué",
    disclaimer:
      "Cifras ilustrativas con tasas de referencia y reglas ISR simplificadas (retención LIF, 10% en acciones listadas, diferido en Afore). Confirma con tu casa de bolsa o contador.",
...
export const en: Dictionary = {
  ...
  cards: {
    ...
    adjustProcessing: "Adjust for processing",
    adjustProcessingTitle: "Adjust for processing",
    adjustProcessingHint:
      "A charge made before the cut-off can post after it and land on the next statement. Enter the statement balance at cut-off (billed charges, not the balance after you paid).",
    adjustStatementBalance: "Balance at cut-off",
    adjustAppCharged: "Charges in the app",
    adjustDifference: "Difference",
    adjustAppHigher:
      "The app has {amount} more than the bank. Mark the charges that posted late to move them to the next cycle.",
    adjustAppLower:
      "The bank billed {amount} more. Mark next-cycle charges that posted early, or undo a previous adjustment.",
    adjustMatch: "The statement balance matches the app.",
    adjustSuggested: "Suggestion",
    adjustSuggestedExact: "Exact match",
    adjustSuggestedClose: "Close: {amount} short",
    adjustUseSuggestion: "Use this suggestion",
    adjustSelected: "Selected {selected} of {target}",
    adjustSelectedMatch: "Selection matches",
    adjustMoveNext: "Move to next cycle",
    adjustPullThis: "Move into this cycle",
    adjustRestore: "Return to this cycle",
    adjustAlreadyMoved: "Already moved to the next cycle",
    adjustFromNext: "Charges from the next cycle",
    adjustSuccess: "Cycle adjusted",
    adjustNothing: "Select at least one charge",
    adjustShifted: "Adjusted for processing",
    adjustUndoShift: "Undo adjustment",
    adjustEnterBalance: "Enter the balance at cut-off to calculate the gap and suggest charges.",
    adjustNoCandidates: "There are no charges to adjust in this cycle.",
    adjustConfirmUndo: "Return this charge to the cycle implied by its purchase date?",
  },
  ...
  debts: {
    title: "Debts",
    subtitle: "Payments, interest, and how paying more or less changes the cost",
    new: "New debt",
    principal: "Principal",
    ...
    nextPayment: "Next payment",
    nextInterest: "Interest this month",
    nextCapital: "Toward principal",
    paidInterest: "Interest already paid",
    ifYouKeepPaying: "If you keep paying {payment} / month",
    payoffIn: "Paid off in {duration}",
    totalInterestLeft: "Interest still to pay {amount}",
    wontPayOff:
      "This payment does not cover interest. The balance will not go down.",
    minToReduce: "Minimum to reduce the balance: {amount}",
    simulate: "Try a different payment plan",
    tryPayment: "Payment to simulate",
    savePayment: "Use this monthly payment",
    savePlan: "Use this plan",
    paymentSaved: "Payment updated",
    planSaved: "Payment plan updated",
    interestSaved: "You save {amount} in interest",
    interestExtra: "You would pay {amount} more in interest",
    fasterBy: "Finish {duration} sooner",
    slowerBy: "Take {duration} longer",
    samePlan: "Same time and interest",
    durationMonths: "{n} months",
    durationYears: "{y} years",
    durationYearsMonths: "{y} years and {m} months",
    schedule: "How interest is applied",
    scheduleMonth: "Month",
    zeroRate:
      "Rate is 0%. Set the annual % to see interest and how payments change it.",
    ...
    planStep: "Payment {n}",
    planSum: "Plan cash total: {amount}",
    planVsRemaining: "Principal remaining: {remaining}",
    planShort: "Plan cash is less than principal (short {amount} of principal alone).",
    planLong: "Plan has {amount} more than principal; some of that may go to interest.",
    planMatch: "Plan cash equals principal (interest may still leave a balance).",
    planPaysOff: "This plan pays off the debt. Total interest in the plan: {interest}.",
    planLeavesBalance:
      "After this plan you would still owe {amount}. Interest takes part of each payment, not only principal.",
    planInterestShort:
      "Plan cash covers the principal on paper, but with interest a balance of {amount} would remain. Raise a payment or add installments.",
  ...
  settings: {
    ...
    meatLink: {
      title: "Meat connection",
      subtitle:
        "When you mark a shopping list as bought in Meat, that spend is posted here as a movement.",
      enable: "Accept expenses from Meat",
      generate: "Generate key",
      rotate: "Regenerate key",
      revoke: "Revoke key",
      tokenOnce: "Copy this key now. It will not be shown in full again.",
      tokenCopied: "Key copied",
      copyKey: "Copy key",
      hasToken: "Active key ({prefix}…)",
      noToken: "No key yet. Generate one to connect Meat.",
      account: "Account that pays",
      card: "Or card (if you are not using an account)",
      category: "Category",
  ...
  ai: {
    ...
    providerOpenai: "OpenAI",
    providerGemini: "Gemini",
    providerCustom: "Local / custom URL (Ollama, LM Studio…)",
    baseUrl: "Base URL",
    baseUrlHint: "Local examples: http://127.0.0.1:11434/v1 (Ollama) or http://127.0.0.1:1234/v1 (LM Studio).",
    model: "Model",
    apiKey: "API key",
    apiKeyHint: "Paste your key. Local models often work with this left blank.",
    clearKey: "Remove key",
    ...
    consentBody:
      "When you ask, Finance builds a snapshot of the accounts, movements, budgets, and debts you can see and sends it to the provider you configured (xAI, OpenAI, Google, or a model on your network). Finance does not use its own key: traffic goes on your subscription and may be covered by that provider’s policy.",
    consentCheck: "I understand and agree to send a summary of my logged data to that provider.",
  ...
  marketplace: {
    ...
    modules: {
      ...
      prices: {
        title: "Store prices",
        description:
          "Compare the same item across stores and link purchases to movements to see how much you saved or overpaid.",
      },
      investments: {
  ...
  properties: {
    ...
    paymentDay: "Payment day",
    financeLink: "Loan on this asset",
    financeNone: "No mortgage or loan",
    financeExisting: "Link an existing liability",
    financeCreate: "Create mortgage / loan",
    financeHint:
      "Home − mortgage = equity. Monthly payments are recorded in Debts, not here.",
    equity: "Equity",
    equityOf: "Equity {amount}",
    linkedLiability: "Liability: {name}",
    ...
    chartNeedDates: "Set an acquired date to see the chart.",
    chartHousehold: "Net worth over time",
    chartFuture: "Project 3 years",
    chartLegendValue: "Value",
    chartLegendEstimate: "Estimate",
    chartLegendEquity: "Equity",
    ownership: "Owners",
    ownershipHint:
      "Each member’s share. Anything left unassigned stays with the household.",
    ownershipHousehold: "Household (unassigned)",
    ownershipTotal: "Assigned {pct}%",
    ownershipOver: "Total {pct}% — cannot exceed 100%.",
  ...
  prices: {
    title: "Store prices",
    subtitle: "Compare stores and link purchases to movements to see real savings",
    stores: "Stores",
    items: "Items",
    addStore: "Add store",
    seedStores: "Common MX stores",
    addItem: "Add item",
    ...
    unitL: "Liter",
    unitPack: "Pack",
    addQuote: "Log a price",
    unitPrice: "Unit price",
    observedOn: "Price date",
    latest: "Latest prices",
    cheapest: "Cheapest: {store} {amount}",
    noQuotes: "No prices yet. Log one or link a purchase.",
    noItems: "Add milk, eggs, gas… anything you want to compare.",
    noStores: "Add the stores where you shop.",
    linkPurchase: "Link a movement",
    pickTxn: "Movement",
    quantity: "Quantity",
    paidTotal: "Amount paid (blank = the movement)",
    purchases: "Linked purchases",
    saved: "You saved {amount} vs the cheapest known store",
    couldSave: "You could have saved {amount} at {store}",
    noCompare: "No other stores to compare",
    paidUnit: "You paid {amount} / {unit}",
    totalsSaved: "Saved by choosing well",
    totalsCould: "Left on the table",
    totalsSpent: "Spent on linked purchases",
    linked: "Purchase linked",
    created: "Created",
    quoteAdded: "Price saved",
    confirmDelete: "Delete?",
    emptyTxns: "No recent expenses to link.",
  },

  investments: {
    title: "Advanced investments",
    subtitle:
      "Best option for your risk, horizon, and ISR. Guidance, not tax advice.",
    risk: "Risk level",
    riskLow: "Low (preserve)",
    riskMedium: "Medium",
    riskHigh: "High (grow)",
    horizon: "Horizon (years)",
    amount: "Amount to invest",
    tax: "Marginal ISR %",
    taxHint: "Your effective or bracket rate (0–35). Changes CETES vs equity ranking.",
    best: "Best for you",
    afterTax: "Net yield ≈ {pct}%",
    preTax: "Gross {pct}%",
    taxDrag: "Est. tax {pct} pts",
    yearGain: "In one year ≈ {amount} (after ISR)",
    yearTax: "Estimated ISR {amount}",
    liquidity: "Liquidity ~{n} days",
    why: "Why",
    disclaimer:
