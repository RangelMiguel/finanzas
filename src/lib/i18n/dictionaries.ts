export const es = {
  ...
  security: {
    ...
    previewTitle: "Vista previa de la política",
    previewSubtitle: "Así se vería la app con esta política (rol {role})",
    previewAdminNote:
      "Admin y owner tienen acceso total en la app real; esta vista muestra la política guardada de todos modos.",
    previewModules: "Pantallas visibles",
    previewModulesNone: "Ningún módulo activo",
    previewHidden: "Oculto",
    previewVisible: "Visible",
    previewTxn: "Movimientos",
    previewAccounts: "Cuentas visibles",
    previewCards: "Tarjetas visibles",
    previewDebts: "Deudas visibles",
    previewFlags: "Otras reglas",
    previewBalancesOn: "Ve saldos de cuentas",
    previewBalancesOff: "No ve saldos de cuentas",
    previewOnlyOwn: "Solo sus propios movimientos",
    previewAllTxn: "Ve movimientos de todos",
    previewNamesOn: "Ve nombres de otros miembros",
    previewNamesOff: "No ve nombres de otros",
    closePreview: "Cerrar",
...
export const en: Dictionary = {
  ...
  security: {
    ...
    previewSubtitle: "How the app would look with this policy (role {role})",
    previewAdminNote:
      "Admins and owners always get full access in the real app; this preview still shows the stored policy.",
    previewModules: "Visible screens",
    previewModulesNone: "No modules enabled",
    previewHidden: "Hidden",
    previewVisible: "Visible",
    previewTxn: "Transactions",
    previewAccounts: "Visible accounts",
    previewCards: "Visible cards",
    previewDebts: "Visible debts",
    previewFlags: "Other rules",
    previewBalancesOn: "Sees account balances",
    previewBalancesOff: "Does not see account balances",
    previewOnlyOwn: "Only their own transactions",
    previewAllTxn: "Sees everyone's transactions",
    previewNamesOn: "Sees other members' names",
    previewNamesOff: "Does not see other members' names",
    closePreview: "Close",
